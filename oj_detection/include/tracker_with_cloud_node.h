...
private:
    ...
    ros::Publisher _projection_cloud_pub;
    ros::Publisher _old_projection_cloud_pub;
    ...
    message_filters::Subscriber<sensor_msgs::PointCloud2> _point_sub;
...
public:
    ...
    visualization_msgs::MarkerArray createLabelArray(const vision_msgs::Detection3DArray& detections3d_msg);
